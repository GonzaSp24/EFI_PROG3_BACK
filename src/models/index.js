...
export const models = {
    ...
    User, Customer,
    // Devices
    Brand, DeviceModel, Device, CustomerDevice,
    // Orders
    RepairOrder, OrderHistory, RepairTask, Diagnostic, TestChecklistItem,
    // Inventory
    Supplier, Part, PartCompatibility, InventoryMovement,
    // Billing
